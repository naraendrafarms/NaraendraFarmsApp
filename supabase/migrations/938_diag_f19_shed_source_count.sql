-- Migration 938 (READ ONLY): retry of 937 without the unused DO block (which
-- risked desyncing statement parsing per the $$ marker warning). Same two
-- diagnostic queries: why does Bulk Daily Entry now show 19 sheds for Flock 19.
