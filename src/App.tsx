...
import { FlockWeeklyPerformance } from '@/pages/flocks/FlockWeeklyPerformance'
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route element={<PrivateRoute><AppLayout /></PrivateRoute>}>
            ...
            <Route path="flocks/hatch-analysis" element={<HatchAnalysis />} />
            ...
            <Route path="employees/workforce-review" element={<WorkforceReviewPage />} />
            ...
            <Route path="flocks/weekly-performance" element={<FlockWeeklyPerformance />} />
