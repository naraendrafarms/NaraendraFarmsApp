...
const CHANGELOG: ChangeEntry[] = [
  { date: '2026-07-17', tag: 'New',      text: 'Masters → Vaccination Schedule → Link Unlinked Vaccines: a line combining two vaccines given together (e.g. "AE + FP") can\'t be linked to a single Medicines Master entry — the tool now detects the "+" pattern and offers to split it into one row per vaccine (same age/dose/route/product/notes carried to each), so each can then be linked or created individually.' },
