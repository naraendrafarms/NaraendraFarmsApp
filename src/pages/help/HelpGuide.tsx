    ...
    workflows: [
      ...
      },
      {
        ...
        steps: [
          ...
          { text: 'The four tiles at the top are worked out from the summed counts of every batch on the page, never from a stored percentage: Total Eggs Set, Std Chicks (the standard), Chicks Hatched (what the hatchery reported), Avg Fertility = (setting − infertile) ÷ setting, and Avg Hatchability = hatched ÷ (setting − infertile − blasters).', note: 'This is why imported batches count towards them exactly like typed ones.' },
        ]
      },
      {
