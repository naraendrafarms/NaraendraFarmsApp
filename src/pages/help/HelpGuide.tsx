    ...
    workflows: [
      ...
      },
      {
        ...
        steps: [
          ...
          { text: 'The four tiles at the top are worked out from the summed counts of every batch on the page, never from a stored percentage: Total Eggs Set, Std Chicks (the standard), Chicks Hatched (what the hatchery reported), and Avg Hatchability = chicks hatched ÷ TOTAL eggs set.', note: 'This is why imported batches count towards them exactly like typed ones. Hatchability is on the all-eggs-set base, breakage included — not hatched ÷ fertile eggs, which measures the incubator alone and reads about 9 points higher.' },
        ]
      },
      {
