...
const CHANGELOG: ChangeEntry[] = [
  { date: '2026-07-13', tag: 'Fix',      text: 'Items Master → Merge Items: predates the alias system, so merging duplicates would have silently deleted every alias name the duplicate items were known by (item_aliases cascades on delete), reset any linked medicine\'s item link back to unlinked, and could fail outright with a raw database error if a Purchase Intent line pointed at the duplicate. Merge now carries all three over to the kept item correctly.' },
