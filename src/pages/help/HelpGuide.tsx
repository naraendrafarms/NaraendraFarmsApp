...
const CHANGELOG: ChangeEntry[] = [
  ...
  { date: '2026-07-17', tag: 'Improved', text: 'Reports → Daily Summary: added a Site filter (defaults to "All Sites") and replaced the separate per-flock Copy buttons + "Copy All Flocks" button with a single Copy button that copies whatever the page currently shows — every site, or just the one selected.' },
