...
const IMPORT_TYPES: ImportTypeDef[] = [
  {
    ...
    fields: [
      ...
      { key:'trcull_female',     label:'Tr+Cull Female',      type:'int' },
      { key:'trcull_male',       label:'Tr+Cull Male',        type:'int' },
    ...
    try {
      if (importType.id === 'daily_records') {
        ...
        const toInsert = validRows.map(r => ({
          ...
          trcull_female: r.row.trcull_female||0, trcull_male: r.row.trcull_male||0,
